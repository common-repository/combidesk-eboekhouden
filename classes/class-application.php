...
namespace Combidesk\Eboekhouden;
...
class Application {
	...
	public function __construct() {
		$this->plugin_name         = 'combidesk-eboekhouden';
		$this->plugin_product_name = __( 'E-Boekhouden', $this->plugin_name );
		...
		$this->description = __( 'Synchronize your WooCommerce orders automatically to E-Boekhouden', $this->plugin_name );
		$this->run();
	}
	...
	public function woo_hpos_compatibility() {
		if ( class_exists( \Automattic\WooCommerce\Utilities\FeaturesUtil::class ) ) {
			\Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility( 'custom_order_tables', 'combidesk-eboekhouden/combidesk-eboekhouden.php', true );
		}
	}
	...
	function add_combidesk_page() {
		...
		$menu_slug  = 'combidesk-eboekhouden-settings';
	...
	function combidesk_settings() {
		...
		echo '
		  ...
		  <form class="combidesk__cta-form" action="https://combidesk.com/combipackageinstall/woocommerce-eboekhouden" method="GET" target="_BLANK">
		  ...
		  <form class="combidesk__cta-form" action="https://dt51.net/c/" method="GET" target="_BLANK">
			<input type="hidden" name="utm_source" value="combidesk" />
			<input type="hidden" name="utm_medium" value="referral" />
			<input type="hidden" name="utm_term" value="combidesk_cta" />
			<input type="hidden" name="si" value="8677" />
			<input type="hidden" name="li" value="1467268" />
			<input type="hidden" name="wi" value="300865" />
